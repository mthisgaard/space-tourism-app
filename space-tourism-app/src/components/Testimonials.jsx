  ...
  <section id="reviews" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb16 mb-6 relative z-[1]">
      ...
      <div className="w-full md:mt-0 mt-6">
        <p className={`${styles.paragraph} text-left max-w-[470px]`}>Nervous about venturing into the unknown? Don't take our word for it, listen to our happy customers.</p>
      </div>
    </div>
